...
from json import decode, encode_into
...
def _bench_message(n: Int, iters: Int) raises:
    ...
    print("message n=", n, " ser_ns=", ser, " deser_ns=", des, " ops_ser=", 1_000_000_000 // ser, " ops_des=", 1_000_000_000 // des)


def main() raises:
    _bench_message(1, 20000)
    print("ok")

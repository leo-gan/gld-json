...
from wire.number import encoded_float_len, encoded_int_len, write_float_digits, write_int_digits
from wire.string import encoded_string_len, needs_escape, write_string_escaped
